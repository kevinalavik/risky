...
static inline uint16_t be16_to_cpu(uint16_t value)
{
...
static inline uint16_t cpu_to_be16(uint16_t value)
{
	return bswap16(value);
}

static inline uint32_t cpu_to_be32(uint32_t value)
{
	return bswap32(value);
}

static inline uint64_t cpu_to_be64(uint64_t value)
{
